"""
MOC v10.2 — RLlib Configuration with W&B Monitoring
=====================================================
...
class MOCTrainingCallbacks(DefaultCallbacks):
    """
...
###############################################################################
# Policy / Obs / Action Specs (must match phase1_policy_training_v10_2.py)
###############################################################################
...
def build_config(
    ...
    wandb_project: str         = "cortex-moc-v10-2",
    wandb_api_key: str         = "",
    ...
    config = (
        PPOConfig()
        .environment(
            env="MOCCombatEnv-v0",   # registered in train_rllib.py
            env_config={
        ...
        .callbacks(MOCTrainingCallbacks)
        .resources(
...
def build_wandb_callback(
    ...
    Usage (manual loop):
        import wandb
        wandb.init(project="cortex-moc-v10-2")
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="MOC v10.2 RLlib training with W&B")
    ...
    parser.add_argument("--wandb-project",    default="cortex-moc-v10-2")
