"""
MOC v10.2 — AWS Training Automation Script
==========================================
...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(description="MOC v10.2 AWS training launcher")
    ...
    p.add_argument("--wandb-project",      default="cortex-moc-v10-2", help="W&B project name")
