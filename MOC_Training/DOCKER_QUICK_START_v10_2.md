# Docker Quick Start: MOC v10.2 Training
...
- [ ] UE5 Editor running with MOC project
...
**Training Results:**
```
MOC_Training/training_results_v10_2/v10_2_<timestamp>/
├── moc_policy_v10_2.onnx    # Trained model for UE5
...
```
MOC_Training/models/
└── moc_policy_v10_2.onnx    # Latest exported model
```
...
- Full training guide: `training/README_v10_2.md`
- Architecture specification: `../Source/GameAI_Project/CLAUDE.md`
- Docker configuration: `docker-compose.yml`
- Training implementation: `training/phase1_policy_training_v10_2.py`
