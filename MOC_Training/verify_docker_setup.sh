#!/bin/bash
# Docker Setup Verification Script for MOC v10.2

echo "=================================================="
echo "  MOC v10.2 Docker Setup Verification"
echo "=================================================="
echo ""
...
if [ -f "training/phase1_policy_training_v10_2.py" ]; then
    check_pass "phase1_policy_training_v10_2.py"
else
    check_fail "phase1_policy_training_v10_2.py (missing)"
fi

if [ -f "training/moc_v10_2_env.py" ]; then
    check_pass "moc_v10_2_env.py"
else
    check_fail "moc_v10_2_env.py (missing)"
fi
