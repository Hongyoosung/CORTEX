...
/**
 * ADEPickupBase - Base class for collectible resources
 *
 * Features:
 ...
 *
 * Subclasses:
 * - ADEHealthPack: Instant +40 HP healing
 * - ADEAmmoCrate: +60 rounds ammo refill
 */
UCLASS(Abstract)
class GAMEAI_PROJECT_API ADEPickupBase : public AActor
{
	GENERATED_BODY()
