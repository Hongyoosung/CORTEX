...
#include "BTDecorator_HasEnemyTarget.generated.h"

/**
 * BTDecorator_HasEnemyTarget - Decorator for Enemy Target Validation
 *
 * Functionality:
 ...
 * - Use with BTTask_CombatFire to ensure valid target
