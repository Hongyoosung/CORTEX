 ...
 *
 * Blackboard keys read (set by ADECharacter::PerformTacticalAction):
 *   Weight_EnemyObj, Weight_AllyObj, Weight_Cover, Weight_EnemyVis,
 *   Weight_AllyProx, Weight_Range
 *
 * No dependency on ADEAIController — works with any AAIController.
 */
...
public:
    ...
    ) override
    {
        ...
        // Keys match ADECharacter::PerformTacticalAction() writer
