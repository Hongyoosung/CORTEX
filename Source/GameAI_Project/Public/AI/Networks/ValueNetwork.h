...
#include "AI/Models/LearnedWorldModel.h" // FObservation 정의 포함
#include "ValueNetwork.generated.h"

/**
 * CORTEX v10.1: Value Network (The Evaluator)
 * 상태(State)를 입력받아 승리 확률 또는 기대 가치를 즉시 추정합니다.
 * Random Rollout(심층 시뮬레이션)을 대체합니다.
 */
UCLASS(Blueprintable, BlueprintType)
class GAMEAI_PROJECT_API UValueNetwork : public UObject
{
    GENERATED_BODY()
