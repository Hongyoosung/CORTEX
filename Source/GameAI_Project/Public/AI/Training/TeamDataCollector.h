...
struct GAMEAI_PROJECT_API FTeamTransitionSample
{
	GENERATED_BODY()
 ...
 *
 * Usage:
 * 1. Add component to SquadManager or GameMode
...
class GAMEAI_PROJECT_API UTeamDataCollector : public UActorComponent
{
	GENERATED_BODY()
...
private:
	...
	UPROPERTY()
	TArray<FTeamTransitionSample> CollectedSamples;
