...
#include "DECombatStatsInterface.generated.h"


USTRUCT(BlueprintType)
struct FDECombatStats
{
	GENERATED_BODY()
...
class UDECombatStatsInterface : public UInterface
{
	GENERATED_BODY()
};

class GAMEAI_PROJECT_API IDECombatStatsInterface
{
	GENERATED_BODY()
