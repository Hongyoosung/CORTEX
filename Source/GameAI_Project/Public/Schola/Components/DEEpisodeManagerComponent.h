// DEEpisodeManagerComponent.h - Manages episode lifecycle for Schola environments

#pragma once

#include "CoreMinimal.h"
#include "Components/ActorComponent.h"
#include "DEEpisodeManagerComponent.generated.h"
...
class GAMEAI_PROJECT_API UDEEpisodeManagerComponent : public UActorComponent
{
	GENERATED_BODY()
