...
#include "ScholaCortexAgent.generated.h"
...
class GAMEAI_PROJECT_API UScholaCortexAgent : public UInferenceComponent
{
    GENERATED_BODY()

public:
    UScholaCortexAgent(const FObjectInitializer& ObjectInitializer);
    ...
    // ===== 2. Model Management =====
    /** 런타임에 ONNX 모델 핫로딩 */
    UFUNCTION(BlueprintCallable, Category="CORTEX|Models")
