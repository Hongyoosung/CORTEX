...
- Multi-Head RL Policy: Three strategy-specialized heads (Assault, Defend, Support) that output 8-dim tactical weights for EQS scoring equations.
...
8. HeightAdvantage, Z-axis height difference. Gain a vision bonus by occupying high ground. "Defend: High (+)"
