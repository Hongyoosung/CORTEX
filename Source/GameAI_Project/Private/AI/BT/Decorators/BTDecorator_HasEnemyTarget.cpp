...
#include "AI/BT/Decorators/BTDecorator_HasEnemyTarget.h"
...
UBTDecorator_HasEnemyTarget::UBTDecorator_HasEnemyTarget()
{
...
bool UBTDecorator_HasEnemyTarget::CalculateRawConditionValue(UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory) const
{
...
FString UBTDecorator_HasEnemyTarget::GetStaticDescription() const
{
