...
UMocAgentWorldModel::UMocAgentWorldModel()
{
}

bool UMocAgentWorldModel::InitModel(const FString& ModelPath)
{
...
FBatchModelOutput UMocAgentWorldModel::PredictBatch(const FBatchModelInput& BatchInput)
{
...
void UMocAgentWorldModel::PreprocessInput(const FBatchModelInput& InData)
{
    // 텐서 패킹 로직 구현 위치
}

FBatchModelOutput UMocAgentWorldModel::PostprocessOutput()
{
    // 텐서 언패킹 로직 구현 위치
