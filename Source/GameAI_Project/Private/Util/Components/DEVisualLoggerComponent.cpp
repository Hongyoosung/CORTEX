...
bool UDEVisualLoggerComponent::IsDebugDrawingEnabled() const
{
...
void UDEVisualLoggerComponent::DrawCombatState(
...
void UDEVisualLoggerComponent::DrawLineToTarget(
	const FVector& Start,
	const FVector& End,
	FLinearColor Color,
	bool bDrawArrow
...
void UDEVisualLoggerComponent::DrawTeamLeaderState(
	const FVector& Location,
	int32 FollowerCount,
...
void UDEVisualLoggerComponent::DrawFormationInfo(
...
void UDEVisualLoggerComponent::DrawObjectiveMarkers(
...
void UDEVisualLoggerComponent::DrawDebugText(
	const FVector& Location,
	const FString& Text,
	FLinearColor Color,
	float Duration
...
void UDEVisualLoggerComponent::DrawSphere(
	const FVector& Location,
	float Radius,
	FLinearColor Color,
	float Duration
...
void UDEVisualLoggerComponent::DrawLine(
	const FVector& Start,
	const FVector& End,
	FLinearColor Color,
	float Duration,
...
void UDEVisualLoggerComponent::DrawArrow(
	const FVector& Start,
	const FVector& End,
	FLinearColor Color,
	float ArrowSize,
