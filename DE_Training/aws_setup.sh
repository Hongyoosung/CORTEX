#!/bin/bash
# DE AWS Infrastructure Setup Script
...
echo "============================================================"
echo "DE AWS Infrastructure Setup"
echo "============================================================"
echo ""

# Configuration
export AWS_REGION=${AWS_REGION:-us-east-1}
export KEY_PAIR_NAME=${KEY_PAIR_NAME:-de-key}
export PROJECT_NAME="de"
...
if aws ec2 describe-security-groups \
    ...
    export SG_WORKER=$(aws ec2 create-security-group \
        ...
        --description "DE UE5 Worker Security Group" \
        --vpc-id $VPC_ID \
        --query 'GroupId' \
        --output text)
...
if aws ec2 describe-security-groups \
    ...
    export SG_HEAD=$(aws ec2 create-security-group \
        ...
        --description "DE Training Head Node" \
        --vpc-id $VPC_ID \
        --query 'GroupId' \
        --output text)
...
if aws iam get-role --role-name DE-Worker-Role &> /dev/null; then
    echo "  IAM role already exists: DE-Worker-Role"
else
    # Create trust policy
...
EOF
    ...
    aws iam create-instance-profile \
        --instance-profile-name DE-Worker-Profile || true

    aws iam add-role-to-instance-profile \
        --instance-profile-name DE-Worker-Profile \
        --role-name DE-Worker-Role || true

    # Wait for IAM propagation
    sleep 10

    echo "  Created IAM role: DE-Worker-Role"
