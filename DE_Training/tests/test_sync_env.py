"""
Test Script for DE v10.0 Synchronous Environment
...
import time
import numpy as np
from de_env import DESyncMultiAgentEnv

def test_sync_env():
    """Test synchronous environment behavior."""

    print("=" * 80)
    print("DE v10.0 Synchronous Environment Test")
    print("=" * 80)

    # 1. Environment Creation
    print("\n[TEST 1] Creating environment...")
    try:
        env = DESyncMultiAgentEnv(
            host="localhost",
            port=50051,
            num_envs=4
        )
