...
Image: `de_training-training-single:latest`
...
```bash
cd /c/Users/Foryoucom/Documents/GitHub/DE/DE_Training
...
- **Training Results:** `DE_Training/training_results/`
- **Saved Models:** `DE_Training/models/`
